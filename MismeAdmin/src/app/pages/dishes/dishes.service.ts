...
export class DishesService {
  ...
  getDishes(search: string, tags: number[], page: number, perPage: number, sort: string): Observable<any> {
  ...
  getAdminDishes(): Observable<any> {
    return this.http.get<Dish[]>(Constants.DISH_BASE + '/admin', {
      observe: 'response'
    });
  }
  updateDishTranslations(dishId: number, obj: any): Observable<any> {
  ...
  updateUsersDishAsReviewed(id: number): Observable<any> {
